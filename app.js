...
var AR = {
  ...
  'name': 'محمد محمود السيد أحمد',
  'nameAlt': 'Mohamed Mahmoud Elsayed Ahmed',
  ...
  'fact.city': 'أعمل مع مصر والسعودية',
  'grp.stack': 'أدواتي',
  ...
  'r.tools': 'أدوات في ملف واحد داخل المتصفح — التباين، JSON/CSV، روابط واتساب',
  'r.snake': 'لعبة الثعبان — بدون مكتبات، وتعمل باللمس',
